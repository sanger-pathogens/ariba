...
class TestMlstReporter(unittest.TestCase):
    ...
    def test_one_gene_missing(self):
        ...
        expected_out_all = os.path.join(data_dir, 'mlst_reporter.one_gene_missing.out.all.tsv')
    ...
    def test_het_snps(self):
        ...
        expected_out_all = os.path.join(data_dir, 'mlst_reporter.het_snps.out.all.tsv')
