...
def run():
    ...
    parser.add_argument('--known_vars', choices=['y', 'n'], default='y', help='Output a column for every known variant [%(default)s]', metavar='y|n')
    parser.add_argument('--novel_vars', choices=['y', 'n'], default='y', help='Output a column for every novel variant [%(default)s]', metavar='y|n')
