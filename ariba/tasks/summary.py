...
def run():
    ...
    parser.add_argument('--js_candy', help='Write JS Candy output files, named with the given prefix. Writes a tree and csv file, which can be drag and dropped straight into JS Candy', metavar='files_prefix')
